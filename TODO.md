...
- [ ] API errors should result in visible errors on client side, not just console logs
...
- [ ] Add test coverage reporting and badge to readme
- [ ] Dockerize VLLM so project can all be run at once, front, back and LLM local host
- [ ] Choose LLM to use for Obsidian pipeline app (separate from this project)
- [ ] Improve markdown rendering to support more features (tables, h4, bold, etc.)
